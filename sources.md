...
本页为知识库的公开来源入口。课程合成数据和管理框架已在相应页面标识；厂商资料只用于解释能力、架构或事件，不用于证明企业ROI。

| 主题 | 官方或一手来源 | 使用边界 |
|---|---|---|
| 近期模型能力 | [OpenAI GPT-6 Astra](https://openai.com/index/gpt-6-astra/)、[Gemini 3.8 Flash](https://deepmind.google/models/model-cards/gemini-3-8-flash/)、[qwen3.8-max](https://www.alibabacloud.com/help/en/model-studio/qwen3-8-max)、[Claude Fable 5.1](https://www.anthropic.com/claude/fable) | 厂商发布；只说明能力方向和开放范围 |
| 主动检索 | [Microsoft Agentic Retrieval](https://learn.microsoft.com/en-us/azure/search/agentic-retrieval-overview) | 产品文档；部分能力状态需按日期复核 |
